class GUI{
  ...
  void createGrassGraphs(){
    mgGG = new BRMidGraph(width - GUI_MARGIN - this.VSpacing * 6.5, 60, 150, this.VSpacing * 0.7, -MAX_DEATH_RATE,0,MAX_GROWTH_RATE);
    mgGG.showTitle();
    mgGG.changeTitle("green crop growth");
    mgGG.setTitleColor(textColor);
    mgGG.rotateChart(-HALF_PI);
    
    mgBG = new BRMidGraph(width - GUI_MARGIN - this.VSpacing * 4.5, 60, 150, this.VSpacing * 0.7, -MAX_DEATH_RATE,0,MAX_GROWTH_RATE);
    mgBG.showTitle();
